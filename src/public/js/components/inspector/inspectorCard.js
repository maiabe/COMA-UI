...
export class InspectorCard {
    ...
    addFormFieldFunctions(moduleKey, formCard, fields, fieldsTooltip) {
        var formFields = formCard.getFormFields();
        formFields.forEach((formField) => {
            ...
            if (fieldElement) {
                ...
                if (match.length > 0) {
                    let tooltip = formCard.appendToolTip(match[0].format, fieldLabel);
