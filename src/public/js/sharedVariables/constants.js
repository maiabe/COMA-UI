...
const PROCESSOR_MANAGER = 17;  // change the indexing later 
...
export {
    ...
    INPUT_MANAGER, INSPECTOR, INSPECTOR_CARD, INSPECTOR_CARD_MAKER, POPUP_MANAGER, POPUP, POPUP_CONTENT_MAKER, OUTPUT_MANAGER, PROCESSOR_MANAGER, PIPELINE_MANAGER, WORKER_MANAGER, DOM_MANAGER, compositIcon,
